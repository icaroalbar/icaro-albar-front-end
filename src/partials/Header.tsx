...
export function Header(): ReactElement {
  return (
    <section className="grid grid-cols-2 items-start gap-x-5 px-20">
      <div className="col-span-2 lg:col-span-1 py-32 text-center sm:text-start">
        <h6 className="text-h6 uppercase bg-clip-text text-transparent bg-gradient-to-b from-blue-600 to-primary-10">
          desenvolvedor full-stack
        </h6>
        <h1 className="text-h2 md:text-h1 capitalize text-slate-300 tracking-[0.4rem]">
          icaro albar
        </h1>
      ...
      <div className="col-span-1 hidden text-red-500 lg:flex justify-center items-center blur-full">
